...
export default function Scoreboard() {
  ...
  return (
    <div className="m-0   bg-neutral-900 ">
      <div className="flex items-center p-6 justify-center gap-4">
        <button
          onClick={() => navigate("/")}
          className="p-2 py-2 rounded-lg shadow-md bg-black text-white"
        >
          {" "}
          <FontAwesomeIcon icon={faArrowLeft} /> Go back
        </button>

        <h3 className="text-teal-500  text-center text-4xl">
          Overall Leaderboard
        </h3>
      </div>
